...
# batch_main.jl 
dt1 = SampleDataTable(CSV.read(joinpath(@__DIR__(), "..", "data", "sample.txt"), DataFrame; delim = '\t'), Symbol("Data File"))
dt2 = AnalyteDataTable(CSV.read(joinpath(@__DIR__(), "..", "data", "analyte.txt"), DataFrame; delim = '\t'), :Analyte)
...
CQA.write(joinpath(@__DIR__(), "..", "data", "precompile", "batch1.batch"), batch1; delim = '\t')
CQA.write(joinpath(@__DIR__(), "..", "data", "precompile", "batch2.batch"), batch2; delim = '\t')